...
func (h *Handler) RegisterRoutes(r *gin.Engine) {
	...
	api.POST("/quality-test-batches/options", h.QualityTestBatchOptions)
	api.POST("/quality-test-batches", h.CreateQualityTestBatch)
	api.GET("/quality-test-batches/:id", h.GetQualityTestBatch)
	api.POST("/quality-test-batches/:id/cancel", h.CancelQualityTestBatch)
	api.POST("/quality-tests/:id/retry", h.RetryQualityTest)
